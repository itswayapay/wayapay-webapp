...
const endpoint = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUri}account/`;
let AuthService = class AuthService {
    constructor(http, router) {
        this.http = http;
        this.router = router;
        this.registerEndpoint = `${endpoint}user-registration/`;
        this.verifyEndpoint = `${endpoint}user-verification/`;
        this.pinEndpoint = `${endpoint}user-pin/`;
        this.loginEndpoint = `${endpoint}user-login/`;
        this.logoutEndpoint = `${endpoint}logout/`;
    ...
    post_register_user(data) {
        return this.http.post(this.registerEndpoint, data, this.noTokenHeader)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    post_verify_user(data) {
        return this.http.post(this.verifyEndpoint, data, this.noTokenHeader)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    post_pin_user(data) {
        return this.http.post(this.pinEndpoint, data, this.noTokenHeader)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    post_login_user(data) {
        return this.http.post(this.loginEndpoint, data, this.noTokenHeader)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
    }
    logout() {
        this.clearLocalData();

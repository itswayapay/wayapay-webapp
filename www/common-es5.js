(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesAuthAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const endpoint = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUri, "account/");
    let AuthService = class AuthService {
      constructor(http, router) {
        this.http = http;
        this.router = router;
        this.registerEndpoint = "".concat(endpoint, "user-registration/");
        this.verifyEndpoint = "".concat(endpoint, "user-verification/");
        this.pinEndpoint = "".concat(endpoint, "user-pin/");
        this.loginEndpoint = "".concat(endpoint, "user-login/");
        this.logoutEndpoint = "".concat(endpoint, "logout/");
        this.registerUserSource = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](null);
        this.registerUserObv = this.registerUserSource.asObservable();
      }
        ...
        if (getLocToken) {
          getLocHeader = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              ...
              'Access-Control-Allow-Origin': '*',
              'Access-Control-Allow-Methods': 'POST, GET, OPTIONS, PUT',
              Authorization: "Bearer ".concat(getLocToken)
            })
          };
      ...
      post_register_user(data) {
        return this.http.post(this.registerEndpoint, data, this.noTokenHeader).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
      }

      post_verify_user(data) {
        return this.http.post(this.verifyEndpoint, data, this.noTokenHeader).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
      }

      post_pin_user(data) {
        return this.http.post(this.pinEndpoint, data, this.noTokenHeader).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
      }

      post_login_user(data) {
        return this.http.post(this.loginEndpoint, data, this.noTokenHeader).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError));
      }
